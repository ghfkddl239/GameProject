...
public class FirstPersonControllerCustom : MonoBehaviour
{
    ...
    private PlayerGroundCheckerCS groundChecker;
    ...
    public float skyXAngleLimit = -60f;
    public float groundXAngleLimit = 15f;
    ...
    private void Awake()
    {
        ...
        groundChecker = GetComponent<PlayerGroundCheckerCS>();
    ...
    private void Update()
    {
        ...
        if(cameraCanMove)
        {
            ...
            pitch = Mathf.Clamp(pitch, skyXAngleLimit, groundXAngleLimit);
...
// Custom Editor
#if UNITY_EDITOR
    [CustomEditor(typeof(FirstPersonControllerCustom)), InitializeOnLoadAttribute]
    public class FirstPersonControllerCustomEditor : Editor
    {
    ...
    {
        fpc = (FirstPersonControllerCustom)target;
    ...
    public override void OnInspectorGUI()
    {
        ...
        fpc.skyXAngleLimit = EditorGUILayout.Slider(new GUIContent("Up Camera Rotation Limit",""), fpc.skyXAngleLimit,0,-60f);
        fpc.groundXAngleLimit = EditorGUILayout.Slider(new GUIContent("Down Camera Rotation Limit",""), fpc.groundXAngleLimit,0,15f);
